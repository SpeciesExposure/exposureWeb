...
<img src="img/shinyApp.png" alt="Screenshot of the Shiny app showing a species timeseries and map" style="max-width:20%; border:1px solid #ddd; border-radius:4px; margin:1rem 0;">
